/** shadcn-style Command palette wrapping cmdk for type-safe usage */
"use client";
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-[var(--radius-card)]",
...
const CommandShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto inline-flex items-center gap-1 text-[0.625rem] tracking-wider text-muted-foreground",
      className
    )}
    {...props}
  />
