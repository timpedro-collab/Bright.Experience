/**
 * PublicSiteChrome — the single source of truth for public marketing chrome.
 *
 * Renders the editorial Bright.Experience nav, the persistent partner
 * attribution banner, and the editorial footer (bright.blue lockup, locations
 * strip, link columns). Shared by the `(public)` route-group layout and the
 * logged-out landing page so every cold-visitor surface has identical
 * wayfinding instead of two drifting copies.
 */
