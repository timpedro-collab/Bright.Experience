...
export const EXTRA_TABLES: Record<string, MockRow[]> = {
  ...
  placements: [
    { id: PL_MANCHESTER_SUMMER, venue_id: VENUE_MANCHESTER, machine_instance_id: MI_PRO1, start_date: "2026-07-01", end_date: "2026-07-31", status: "active", pricing_model_json: { model: "revenue_share", rate: 0.15, floor_gbp: 4000 }, notes: "Ground-floor atrium, peak summer footfall.", sku_code: "MAN-AT-01", location_label: "Ground-floor atrium", footfall_estimate: 38000, max_slots_per_sponsor: 2, sku_status: "live", created_at: "2026-05-20T09:00:00Z", updated_at: "2026-06-18T09:00:00Z" },
    ...
    { id: PL_WESTFIELD_SUMMER, venue_id: VENUE_WESTFIELD, machine_instance_id: null, start_date: "2026-08-01", end_date: "2026-08-31", status: "active", pricing_model_json: { model: "revenue_share", rate: 0.18, floor_usd: 6000 }, notes: "The Street, ground floor — flagship summer footfall.", sku_code: "WES-ST-01", location_label: "The Street, ground floor", footfall_estimate: 42000, max_slots_per_sponsor: 2, sku_status: "live", created_at: "2026-06-05T09:00:00Z", updated_at: "2026-06-18T09:00:00Z" },
    // Draft on purpose: demonstrates the approval step — invisible on the
    // public advertise page until the venue publishes it.
    { id: PL_NEC_AUTUMN, venue_id: VENUE_NEC, machine_instance_id: null, start_date: "2026-10-10", end_date: "2026-10-25", status: "planned", pricing_model_json: { model: "fixed_fee", fee_usd: 22000 }, notes: "Hall 5 concourse, tied to autumn trade-show season.", sku_code: "NEC-H5-01", location_label: "Hall 5 concourse", footfall_estimate: 55000, max_slots_per_sponsor: null, sku_status: "draft", created_at: "2026-06-12T11:00:00Z", updated_at: "2026-06-12T11:00:00Z" },
  ],
