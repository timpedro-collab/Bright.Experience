...
export const MOCK_TABLES: Record<string, MockRow[]> = {
  ...
  event_reports: [
    ...
    },
    {
      ...
      metrics_json: { totalPlays: 5690, totalInteractions: 7700, totalLeads: 1877, totalPrizes: 1329, avgDwellTime: 48.9, snapshotCount: 3 },
      predictions_json: { estimatedInteractions: 7000, estimatedLeads: 1700 },
      comparison_json: {
        interactions: { predicted: 7000, actual: 7700, delta: 700 },
        leads: { predicted: 1700, actual: 1877, delta: 177 },
      },
    ...
    },
    {
      ...
      metrics_json: { totalPlays: 5050, totalInteractions: 6730, totalLeads: 1660, totalPrizes: 1167, avgDwellTime: 46.7, snapshotCount: 3 },
      predictions_json: { estimatedInteractions: 6000, estimatedLeads: 1500 },
      comparison_json: {
        interactions: { predicted: 6000, actual: 6730, delta: 730 },
        leads: { predicted: 1500, actual: 1660, delta: 160 },
      },
  ...
  event_metrics_snapshot: [
    { event_id: "e6666666-6666-6666-6666-666666666666", snapshot_date: "2026-03-20", total_plays: 1840, total_interactions: 2510, total_leads: 612, total_prizes: 430, avg_dwell_time: 47.5, peak_hour: 14, is_final: false },
    { event_id: "e6666666-6666-6666-6666-666666666666", snapshot_date: "2026-03-21", total_plays: 2120, total_interactions: 2890, total_leads: 705, total_prizes: 498, avg_dwell_time: 51.2, peak_hour: 15, is_final: false },
    { event_id: "e6666666-6666-6666-6666-666666666666", snapshot_date: "2026-03-22", total_plays: 1730, total_interactions: 2300, total_leads: 560, total_prizes: 401, avg_dwell_time: 48.0, peak_hour: 13, is_final: true },
    { event_id: "e5555555-5555-5555-5555-555555555555", snapshot_date: "2026-04-10", total_plays: 1620, total_interactions: 2180, total_leads: 540, total_prizes: 372, avg_dwell_time: 44.8, peak_hour: 16, is_final: false },
    { event_id: "e5555555-5555-5555-5555-555555555555", snapshot_date: "2026-04-11", total_plays: 1980, total_interactions: 2640, total_leads: 631, total_prizes: 455, avg_dwell_time: 49.1, peak_hour: 15, is_final: false },
    { event_id: "e5555555-5555-5555-5555-555555555555", snapshot_date: "2026-04-12", total_plays: 1450, total_interactions: 1910, total_leads: 489, total_prizes: 340, avg_dwell_time: 46.3, peak_hour: 14, is_final: true },
  ],
