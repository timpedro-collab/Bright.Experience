 ...
 * with the partner's name, optional logo, and accent colour. From here the
 * customer can dive into any public funnel surface; the cookie travels
 * silently and the server actions read it on submit (see
 * {@link submitBookNowQuote} and {@link submitProposalIntake}).
 *
        ...
        <Container>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Tile
              ...
              body="Standard packages priced and ready — configure, pay, done."
...
function Tile({
  ...
  return (
    <Link
      href={href}
      className="group rounded-[var(--radius-card)] border border-white/[0.06] bg-white/[0.02] p-6 transition-all hover:border-white/20 hover:-translate-y-0.5"
    >
