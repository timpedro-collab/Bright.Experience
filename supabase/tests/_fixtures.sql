...
--   user_partner_admin  → partner_admin @ Northern      (00000000-0000-4000-8000-000000000030)
--   user_partner_member → partner_member @ Northern     (00000000-0000-4000-8000-000000000031)
--   user_venue_admin    → partner_admin @ Kings Cross   (00000000-0000-4000-8000-000000000032)
--
-- Accounts:
...
--
-- Partners:
--   ptn_north  (type=reseller) (00000000-0000-4000-8000-0000000000b1)
--   ptn_kings  (type=venue)    (00000000-0000-4000-8000-0000000000b2)
--
-- Venues:
--   ven_north  (partner=north) (00000000-0000-4000-8000-0000000000c1)
--   ven_kings  (partner=kings) (00000000-0000-4000-8000-0000000000c2)
-- =====================================================================
...
values
  ...
  ('00000000-0000-4000-8000-000000000030', 'lead@northern.test',        '', now(), '{}', now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('00000000-0000-4000-8000-000000000031', 'member@northern.test',      '', now(), '{}', now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('00000000-0000-4000-8000-000000000032', 'lead@kingscross.test',      '', now(), '{}', now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated')
...
insert into profiles (id, name, email, role, account_id, is_active) values
  ...
  ('00000000-0000-4000-8000-000000000030', 'North Lead',     'lead@northern.test',       'partner_admin',  null,                                       true),
  ('00000000-0000-4000-8000-000000000031', 'North Member',   'member@northern.test',     'partner_member', null,                                       true),
  ('00000000-0000-4000-8000-000000000032', 'KC Lead',        'lead@kingscross.test',     'partner_admin',  null,                                       true)
on conflict (id) do nothing;
...
-- Partners and venues for partner / venue portal tests.
insert into partners (id, name, slug, type, partner_code, status) values
  ('00000000-0000-4000-8000-0000000000b1', 'Northern Events', 'northern', 'reseller', 'BB-NORTH001', 'active'),
  ('00000000-0000-4000-8000-0000000000b2', 'Kings Cross',     'kings-cross', 'venue', 'BB-KINGS001', 'active')
on conflict (id) do nothing;

insert into partner_users (id, partner_id, profile_id, role) values
  ('00000000-0000-4000-8000-0000000000f1', '00000000-0000-4000-8000-0000000000b1', '00000000-0000-4000-8000-000000000030', 'admin'),
  ('00000000-0000-4000-8000-0000000000f2', '00000000-0000-4000-8000-0000000000b1', '00000000-0000-4000-8000-000000000031', 'member'),
  ('00000000-0000-4000-8000-0000000000f3', '00000000-0000-4000-8000-0000000000b2', '00000000-0000-4000-8000-000000000032', 'admin')
on conflict (id) do nothing;

insert into venues (id, partner_id, name, slug, is_active) values
  ('00000000-0000-4000-8000-0000000000c1', '00000000-0000-4000-8000-0000000000b1', 'Northern Hub', 'northern-hub', true),
  ('00000000-0000-4000-8000-0000000000c2', '00000000-0000-4000-8000-0000000000b2', 'Kings Cross Hall', 'kings-cross-hall', true)
on conflict (id) do nothing;
